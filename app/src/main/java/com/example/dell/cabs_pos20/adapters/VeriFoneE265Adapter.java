...
public class VeriFoneE265Adapter extends RecyclerView.Adapter<VeriFoneE265Adapter.CustomViewHolder>{
    private List<ImageVideoRetrieval> arrayList;
    private ViewPagerAdapter adapter;
    private View view;
    private Context mContext;

    public VeriFoneE265Adapter(List<ImageVideoRetrieval> arrayList, Context mContext) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new VeriFoneE265Adapter.CustomViewHolder(view);
    }
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.VE265,arrayList.get(position).getErrors());
